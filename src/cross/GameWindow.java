...
class GameWindow extends JFrame {
    ...
    private static final int WIN_WIDTH = 510; // ширина окна
    private static final int WIN_POS_X = 300; // начальная координата
    private static final int WIN_POS_Y = 0; // начальная координата
